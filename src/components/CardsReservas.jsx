...
const CardsReservas = () => {
  ...
  const [mapUrl, setMapUrl] = useState('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.8354345096036!2d144.9537363153155!3d-37.817209979751984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0x5045675218ce6e0!2sMelbourne%20VIC%2C%20Australia!5e0!3m2!1sen!2sus!4v1631233123456!5m2!1sen!2sus');
                    ...
                    <Card.Body>
                      ...
                      <Col xs={12} md={4}>
                        ...
                        <Col xs={8} className="text-left">
                          ...
                          <h3 className="address-link" onClick={() => handleAddressClick('Avenida Belgrano 3165')}><FaMapMarkerAlt />Avenida Belgrano 3165</h3>
                    ...
                    <Card.Body>
                      ...
                      <Col xs={12} md={4}>
                        ...
                        <Col xs={8} className="text-left ">
                         ...
                         <h3 className="address-link" onClick={() => handleAddressClick('San Juan 3481')}><FaMapMarkerAlt />San Juan 3481</h3>
